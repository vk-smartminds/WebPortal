    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={otpSent ? handleSubmit : handleSendOtp}>
          <input type="text" name="name" placeholder="Student Name" value={form.name} onChange={handleChange} required disabled={otpSent} style={inputStyle} />
          ...
          <input type="text" name="school" placeholder="School (optional)" value={form.school} onChange={handleChange} disabled={otpSent} style={inputStyle} />
          <input type="text" name="class" placeholder="Class" value={form.class} onChange={handleChange} required disabled={otpSent} style={inputStyle} />
          {!otpSent ? (
